...
namespace Microsoft.MixedReality.WebRTC.Unity
{
    ...
    [AddComponentMenu("MixedReality-WebRTC/Video Canvas Renderer")]
    public class VideoCanvasRenderer : MonoBehaviour
    {
        ...
        private void CreateEmptyVideoTextures()
        {
            ...
            videoMaterial = GetComponent<RawImage>().material;
        ...
        public void OnToggleDarkenCameraFeed(bool value)
        {
            if (value)
            {
                videoMaterial.SetFloat("_BackgroundOpacity", 0.8f);
            }
            else
            {
                videoMaterial.SetFloat("_BackgroundOpacity", 0.2f);
            }
        }
    }
}
